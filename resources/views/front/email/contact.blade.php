          ...
          <table cellpadding="0" cellspacing="0" style="width:100%; font-size: 14px; padding: 20px;">
            <tr>
              <td>
                  ...
                  <h5 style="font-size:14px; font-weight: 500; color: #212121; margin: 0 0 5px 26%;"><strong>Name:</strong> {{$data['name']}}</h5>
                  <h5 style="font-size:14px; font-weight: 500; color: #212121; margin: 0 0 5px 26%;"><strong>Email:</strong> {{$data['email']}}</h5>
                  <h5 style="font-size:14px; font-weight: 500; color: #212121; margin: 0 0 5px 26%;"><strong>Phone Number:</strong> {{$data['phone']}}</h5>
                  <h5 style="text-align: justify; width:50%; font-size:14px; font-weight: 500; color: #212121; margin: 0 0 5px 26%;"><strong>Message:</strong> {{$data['message']}}</h5>
