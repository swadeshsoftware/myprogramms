...
@section( 'title' )
{{ isset($pageName)?$pageName:'Services Edit' }}
@endsection
@section('content')
<div class="row mt-5">
  <div class="col">
    <div class="card shadow">
     <!--  <div class="card-header border-0">
      ...
      @endif
         {{ Form::model($data, ['url' => ['admin/services', $data->id], 'method' => 'PUT', 'files' => true, 'class' => '', 'id' => 'testimonial_edit']) }}
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12">
            <div class="form-group">
              ...
              {{ Form::text('alias', null, array('id'=>'alias','class' => 'form-control','readonly'=>'readonly', 'placeholder' => 'Please enter alias')) }}
            </div>
          </div>
          <div class="col-lg-6 col-md-12">
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="form-group">
              ...
              {{ Form::textarea('title', null, array('class' => 'form-control', 'rows'=>'5', 'placeholder' => 'Please enter title')) }}
            </div>
          </div>
        </div>
