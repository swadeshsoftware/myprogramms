                    ...
                    <div class="box box-solid">
                        <div class="box-body">
                            <dl class="dl-horizontal">
                                ...
                                <dd>
                                  @if($data->service_img!='')
                                  <a href="{{url('public'.$data->service_img)}}" class="avatar rounded mr-3"  data-fancybox="{{$data->id}}">
                                    <img src="{{ url('public'.$data->service_img) }}" alt="" style="width:100px; height:100px"/>
                                  </a>
                                  @else
                                   <a href="javascript:void(0);" class="avatar rounded mr-3">
                                    <img src="<?php echo URL::to('/'); ?>/resources/views/admin/assets/img/no_user.png" alt="" style="width:100px; height:100px"/>
