  ...
  <div class="col">
    <div class="card shadow">
     <!--  <div class="card-header border-0">
      ...
      @endif
        {{ Form::open(['url' => 'admin/banners', 'method' => 'POST', 'files' => true, 'class' => '', 'id' => 'form-addedit']) }}
        <div class="row">
...
{!! Html::style('resources/views/admin/assets/css/jquery-confirm.min.css') !!}
...
{{Html::script('resources/views/admin/assets/js/jquery-confirm.min.js')}}
 <!-- <script>
          ...
          jQuery("#form-addedit").validate({
                ...
                messages: { 
                    ...
                    image:{
                      ...
                      //extension: "Please choose valid file type."
                    },
                    service_image: {
                      required: "Please choose image."
                      //extension: "Please choose valid file type."
