  ...
  <div class="col">
    <div class="card shadow">
      <div class="card-header border-1 mt--4">
        ...
        @endif
        {{ Form::open(['route' => 'blogs.index', 'method' => 'get', 'class' => '', 'id' => 'form-search']) }}
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <a href="{{route('blogs.index')}}" class="btn btn-icon btn-2 btn-warning" >
            <span class="btn-inner--icon"><i class="fa fa-sync"></i></span>         
            </a>
            <a href="{{ route('blogs.create') }}" class="btn btn-icon btn-2 btn-success" >
            <span class="btn-inner--icon"><i class="fa fa-plus"></i></span>         
            </a>
           <!--  <a href="Javascript:void(0);" id="delete" class="btn btn-danger  btn-multiple-ids" data-toggle="tooltip" title="Delete"><i class="ni ni-fat-remove fa-add-edit-delete-btn"></i></a>
            {{ Form::open(['method' => 'post', 'route' => 'blogs-multiple-delete', 'id' => 'form-delete-multiple-ids', 'class' => 'hidden']) }} 
          ...
          <tbody>
            ...
            @foreach($datums as $key => $data)
              <tr>
                ...
                <td>
                  <a href="{{route('blogs.edit',$data->id)}}" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                  
                  {{ Form::open(['route' => ['blogs.destroy', $data->id], 'class' =>'form-inline form-delete']) }}
                    {{ Form::hidden('_method', 'DELETE') }}
                    {{ Form::button('<i class="fa fa-trash"></i>', ['type' => 'submit', 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete'] )  }}
                  {{ Form::close() }}
                  <a href="{{ route('blogs.show',  $data->id) }}" data-toggle="tooltip" title="View"><i class="fa fa-eye"></i></a>
                </td>
              </tr>
              <?php $i++;?>
             @endforeach
...
<script type="text/javascript">
  ...
  $('body').on('click','.frontaccess',function(){
      ...
      $.ajax({
        type: "POST",
        url: "{{url('admin/blog-update-status')}}",
