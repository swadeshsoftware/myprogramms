...
@section( 'title' )
{{ isset($pageName)?$pageName:'Blog Edit' }}
@endsection
@section('content')
<div class="row mt-5">
  <div class="col">
    <div class="card shadow">
     <!--  <div class="card-header border-0">
      ...
      @endif
         {{ Form::model($data, ['url' => ['admin/blogs', $data->id], 'method' => 'PUT', 'files' => true, 'class' => '', 'id' => 'blog_edit']) }}
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="form-group">
              <label class="control-label">Title <span style="color: red;">*</span></label>
              {{ Form::text('title', null, array('id'=>'title','class' => 'form-control', 'placeholder' => 'Please enter heading')) }}
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12">
            <div class="form-group">
              <label class="control-label">Meta Author <!-- <span style="color: red;">*</span> --></label>
  ...
  jQuery(document).ready(function(){
          jQuery("#blog_edit").validate({
                ...
                messages: {
                    ...
                    meta_author: {
                      required: "Please enter meta author name."
                    },
                    meta_description: {
