  ...
  <div class="col">
    <div class="card shadow">
     <!--  <div class="card-header border-0">
      ...
      @endif
        {{ Form::open(['url' => 'admin/testimonals', 'method' => 'POST', 'files' => true, 'class' => '', 'id' => 'form-addedit']) }}
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12">
            <div class="form-group">
              ...
              {{ Form::text('designation', null, array('class' => 'form-control', 'placeholder' => 'Please enter designation')) }}
            </div>
          </div>
         <div class="col-lg-4 col-md-12">
            <div class="form-group">
