  ...
  <div class="col">
    <div class="card shadow">
      <div class="card-header border-1 mt--4">
        ...
        @endif
        {{ Form::open(['route' => 'why-choose-us.index', 'method' => 'get', 'class' => '', 'id' => 'form-search']) }}
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <a href="{{route('why-choose-us.index')}}" class="btn btn-icon btn-2 btn-warning" >
            <span class="btn-inner--icon"><i class="fa fa-sync"></i></span>         
            </a>
            <!-- <a href="{{ route('why-choose-us.create') }}" class="btn btn-icon btn-2 btn-success" >
            ...
            @foreach($datums as $key => $data)
              <tr>
                ...
                <span class="badge my-auto"> 
                  <a href="javascript:void(0)" id="act_{{$data->id}}" data-value="2" class="frontaccessnone" data-id="{{$data->id}}" style="{{$act}}" data-toggle="tooltip" data-placement="top" title="Deactive"><i class="fas fa-check-circle" style="color:#57c757;font-size:24px;"></i> </a>

                   <a href="javascript:void(0)" id="dec_{{$data->id}}" data-value="1" class="frontaccessnone" data-id="{{$data->id}}" style="{{$dec}}" data-toggle="tooltip" data-placement="top" title="Active"><i class="fas fa-check-circle" style="color:#d5d5d5;font-size:24px;"></i></a>
                </span>
                </td>
                <td>
                  <a href="{{route('why-choose-us.edit',$data->id)}}" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                 <!--  
                  {{ Form::open(['route' => ['why-choose-us.destroy', $data->id], 'class' =>'form-inline form-delete']) }}
                    {{ Form::hidden('_method', 'DELETE') }}
                    {{ Form::button('<i class="fa fa-trash"></i>', ['type' => 'submit', 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete'] )  }} -->
                  {{ Form::close() }}
                  <a href="{{ route('why-choose-us.show',  $data->id) }}" data-toggle="tooltip" title="View"><i class="fa fa-eye"></i></a>
                </td>
              </tr>
             @endforeach
            @else
...
<script type="text/javascript">
  ...
  //     $.ajax({
  //       type: "POST",
  //       url: "{{url('admin/why-choose-us-update-status')}}",
