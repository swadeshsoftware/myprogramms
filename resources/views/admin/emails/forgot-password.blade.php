...
<tr>
    <td>
        ...
        <table cellpadding="0" cellspacing="0" style=" width:100%; height: 100%; min-height: 100%; min-width: 300px;max-width: 600px; border-spacing: 0px; background: #fff; margin: 60px auto; border-radius: 2px; box-shadow: rgba(0,0,0,0.1) 0 5px 30px;">
            ...
            <?php $site = DB::table('site_settings')->select('*')->first(); ?>
                    ...
                    <table cellpadding="0" cellspacing="0" style=" width:100%;padding:10px; margin: 0 auto; border-bottom: #eee solid 2px;">
                        <tr>
                            <td style="text-align: center;">
                                     @if($site->logo !='')
                                      <img alt="" src="{{url('public/'.$site->logo)}}"  width="150px"/>
                                    @else
                ...
                <td>
                    <table cellpadding="0" cellspacing="0" style="width:100%; font-size: 14px; padding: 20px;">
                        <tr>
                            <td>
                                <p align="center">
                                     <img alt="" src="{{url('resources/views/admin/assets/img/Icons_V2-01.png')}}"  width="150px"/>
                                </p>

                                    <p align="center"><a href="<?php echo URL::to('/').'/admin_password/reset/'.$content['token']; ?>" target="_blank" style="text-decoration: none; padding:10px 20px; background:#ef5350; color: #fff; text-align: center; text-transform: uppercase;">Reset Password</a></p>
                                        <p>&nbsp;</p>
                                        <p>If verify email button doesn't work, copy and paste the following link in your browser: </p>
                                        <p><a href="<?php echo URL::to('/').'/admin_password/reset/'.$content['token']; ?>" target="_blank" style="text-decoration: none; padding:10px 20px;color: #1da253; display: inline-block; text-align: center;font-size: 12px;"><?php echo URL::to('/').'/admin_password/reset/'.$content['token']; ?></a></p>
                            </td>
                        </tr>
                        
                        <tr>
                            <td style="padding:15px; background:#f0f0f0; color: #636363; font-size: 12px; text-align: center;">
                                If you have any comments or questions, please don't hesitate to reach us at <a href="" style="color:#000;"><?php echo $site->email; ?> </a> to hear from you.
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    ...
                    <table cellpadding="0" cellspacing="0" style=" width:100%;padding:15px; margin: 0 auto; border-bottom: #eee solid 2px; background:#263238; text-align: center;">
                        <tr>
                            <td style="color:#fff;">
                                <span style=" color:#C5C5C5;font-size:10px;">{{$site->copyright}}</span>
                            </td>
                        </tr>
                    </table>
                </td>
