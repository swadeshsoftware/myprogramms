...
@section( 'title' )
{{ isset($pageName)?$pageName:'Support Edit' }}
@endsection
@section('content')
<div class="row mt-5">
  <div class="col">
    <div class="card shadow">
     <!--  <div class="card-header border-0">
      ...
      @endif
         {{ Form::model($data, ['url' => ['admin/supports', $data->id], 'method' => 'PUT', 'files' => true, 'class' => '', 'id' => 'testimonial_edit']) }}
        <div class="row">
          <div class="col-lg-6 col-md-12">
            <div class="form-group">
              <label class="control-label">Heading <span style="color: red;">*</span></label>
              {{ Form::text('title_heading', null, array('class' => 'form-control', 'placeholder' => 'Please enter heading')) }}
            </div>
          </div>
          <div class="col-lg-6 col-md-12">
            <div class="form-group">
